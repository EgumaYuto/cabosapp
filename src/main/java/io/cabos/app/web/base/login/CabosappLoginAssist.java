 ...
 */
package io.cabos.app.web.base.login;

import javax.annotation.Resource;

import org.dbflute.optional.OptionalEntity;
import org.dbflute.optional.OptionalThing;
import io.cabos.app.web.signin.SigninAction;
import io.cabos.dbflute.cbean.MemberCB;
import io.cabos.dbflute.exbhv.MemberBhv;
import io.cabos.dbflute.exbhv.MemberLoginBhv;
import io.cabos.dbflute.exentity.Member;
import io.cabos.dbflute.exentity.MemberLogin;
import io.cabos.mylasta.action.CabosappUserBean;
import io.cabos.mylasta.direction.CabosappConfig;
 ...
 * @author jflute
 */
public class CabosappLoginAssist extends TypicalLoginAssist<Integer, CabosappUserBean, Member> // #change_it also UserBean
    ...
    //                                                                       =============
    @Override
    protected CabosappUserBean createUserBean(Member userEntity) {
        return new CabosappUserBean(userEntity);
    }

    @Override
    protected OptionalThing<String> getCookieRememberMeKey() {
        return OptionalThing.of(config.getCookieRememberMeCabosappKey());
    }
    ...
    @Override
    protected void saveLoginHistory(Member member, CabosappUserBean userBean, LoginSpecifiedOption option) {
        asyncManager.async(() -> {
    ...
    //                                                                      ==============
    @Override
    protected Class<CabosappUserBean> getUserBeanType() {
        return CabosappUserBean.class;
    }
