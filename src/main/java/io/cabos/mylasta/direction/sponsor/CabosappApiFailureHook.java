...
import io.cabos.mylasta.direction.sponsor.CabosappApiFailureHook.UnifiedFailureResult.FailureErrorPart;
 ...
 * @author jflute
 */
public class CabosappApiFailureHook implements ApiFailureHook { // #change_it for handling API failure
