 ...
 * @author jflute
 */
public class CabosappSecurityResourceProvider implements SecurityResourceProvider {
    ...
    public CabosappSecurityResourceProvider(InvertibleCryptographer primaryInvertibleCryptographer,
