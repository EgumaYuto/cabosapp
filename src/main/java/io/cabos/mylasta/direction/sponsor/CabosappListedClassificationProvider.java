...
import io.cabos.dbflute.allcommon.DBCurrent;
import io.cabos.mylasta.appcls.AppCDef;
 ...
 * @author jflute
 */
public class CabosappListedClassificationProvider extends TypicalListedClassificationProvider { // basically for HTML response
