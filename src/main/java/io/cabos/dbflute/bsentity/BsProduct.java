 ...
 */
package io.cabos.dbflute.bsentity;
...
import io.cabos.dbflute.allcommon.EntityDefinedCommonColumn;
...
public abstract class BsProduct extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    /**
     * [get] (商品ステータスコード)PRODUCT_STATUS_CODE: {IX, NotNull, CHAR(3), FK to PRODUCT_STATUS} <br>
     * 商品ステータスを識別するコード。
    ...
    /**
     * [set] (商品ステータスコード)PRODUCT_STATUS_CODE: {IX, NotNull, CHAR(3), FK to PRODUCT_STATUS} <br>
     * 商品ステータスを識別するコード。
