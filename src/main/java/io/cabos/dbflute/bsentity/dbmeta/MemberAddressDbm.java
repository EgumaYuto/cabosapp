...
public class MemberAddressDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnRegionId = cci("REGION_ID", "REGION_ID", null, "地域ID", Integer.class, "regionId", null, false, false, true, "INT", 10, 0, null, null, false, null, null, "region", null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "io.cabos.dbflute.exentity.MemberAddress"; }
    public String getConditionBeanTypeName() { return "io.cabos.dbflute.cbean.MemberAddressCB"; }
    public String getBehaviorTypeName() { return "io.cabos.dbflute.exbhv.MemberAddressBhv"; }
