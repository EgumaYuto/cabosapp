...
public class ProductStatusDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "io.cabos.dbflute.exentity.ProductStatus"; }
    public String getConditionBeanTypeName() { return "io.cabos.dbflute.cbean.ProductStatusCB"; }
    public String getBehaviorTypeName() { return "io.cabos.dbflute.exbhv.ProductStatusBhv"; }
