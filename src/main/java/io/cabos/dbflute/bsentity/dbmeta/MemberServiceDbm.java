...
public class MemberServiceDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "io.cabos.dbflute.exentity.MemberService"; }
    public String getConditionBeanTypeName() { return "io.cabos.dbflute.cbean.MemberServiceCB"; }
    public String getBehaviorTypeName() { return "io.cabos.dbflute.exbhv.MemberServiceBhv"; }
