...
public class ProductCategoryDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "io.cabos.dbflute.exentity.ProductCategory"; }
    public String getConditionBeanTypeName() { return "io.cabos.dbflute.cbean.ProductCategoryCB"; }
    public String getBehaviorTypeName() { return "io.cabos.dbflute.exbhv.ProductCategoryBhv"; }
