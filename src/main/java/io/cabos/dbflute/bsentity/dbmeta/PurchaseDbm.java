...
public class PurchaseDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "io.cabos.dbflute.exentity.Purchase"; }
    public String getConditionBeanTypeName() { return "io.cabos.dbflute.cbean.PurchaseCB"; }
    public String getBehaviorTypeName() { return "io.cabos.dbflute.exbhv.PurchaseBhv"; }
