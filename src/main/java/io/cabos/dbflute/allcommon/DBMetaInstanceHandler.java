 ...
 */
package io.cabos.dbflute.allcommon;
...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("MEMBER", "io.cabos.dbflute.bsentity.dbmeta.MemberDbm");
        tmpMap.put("MEMBER_ADDRESS", "io.cabos.dbflute.bsentity.dbmeta.MemberAddressDbm");
        tmpMap.put("MEMBER_FOLLOWING", "io.cabos.dbflute.bsentity.dbmeta.MemberFollowingDbm");
        tmpMap.put("MEMBER_LOGIN", "io.cabos.dbflute.bsentity.dbmeta.MemberLoginDbm");
        tmpMap.put("MEMBER_SECURITY", "io.cabos.dbflute.bsentity.dbmeta.MemberSecurityDbm");
        tmpMap.put("MEMBER_SERVICE", "io.cabos.dbflute.bsentity.dbmeta.MemberServiceDbm");
        tmpMap.put("MEMBER_STATUS", "io.cabos.dbflute.bsentity.dbmeta.MemberStatusDbm");
        tmpMap.put("MEMBER_WITHDRAWAL", "io.cabos.dbflute.bsentity.dbmeta.MemberWithdrawalDbm");
        tmpMap.put("PRODUCT", "io.cabos.dbflute.bsentity.dbmeta.ProductDbm");
        tmpMap.put("PRODUCT_CATEGORY", "io.cabos.dbflute.bsentity.dbmeta.ProductCategoryDbm");
        tmpMap.put("PRODUCT_STATUS", "io.cabos.dbflute.bsentity.dbmeta.ProductStatusDbm");
        tmpMap.put("PURCHASE", "io.cabos.dbflute.bsentity.dbmeta.PurchaseDbm");
        tmpMap.put("PURCHASE_PAYMENT", "io.cabos.dbflute.bsentity.dbmeta.PurchasePaymentDbm");
        tmpMap.put("REGION", "io.cabos.dbflute.bsentity.dbmeta.RegionDbm");
        tmpMap.put("SERVICE_RANK", "io.cabos.dbflute.bsentity.dbmeta.ServiceRankDbm");
        tmpMap.put("WITHDRAWAL_REASON", "io.cabos.dbflute.bsentity.dbmeta.WithdrawalReasonDbm");
